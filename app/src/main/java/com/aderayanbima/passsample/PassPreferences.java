package com.aderayanbima.passsample;
...
/**
 * Created by adera on 11/15/2017.
 */
...
public class PassPreferences {
    ...
    public Integer[] getDesignated()
    {
        ...
        Log.d(TAG, "getDesignated:"+designatedIntArr.length);
        for (int i=0; i<designatedIntArr.length; i++)
        {
